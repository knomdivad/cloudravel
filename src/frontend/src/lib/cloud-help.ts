...
export const HELP_SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Minimum for inventory: permission to call Resource Groups Tagging API GetResources in each region scanned.',
      'Remediation playbooks need the matching write actions on those APIs.',
    ],
    links: [{ label: 'Manage access keys', href: 'https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html' }],
  },
  {
    id: 'aws-regions',
    title: 'Regions',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Enable Cloud Asset API: APIs & Services → Enable APIs → Cloud Asset API.',
      'Grant the SA roles/cloudasset.viewer on the project (inventory). Add write roles only if you use remediation playbooks.',
