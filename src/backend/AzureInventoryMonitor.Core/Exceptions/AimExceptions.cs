namespace AzureInventoryMonitor.Core.Exceptions;

/// <summary>
/// Base exception for all AIM domain errors.
/// </summary>
public abstract class AimException : Exception
{
    public string ErrorCode { get; }

    protected AimException(string errorCode, string message) : base(message)
    {
        ErrorCode = errorCode;
    }

    protected AimException(string errorCode, string message, Exception innerException) : base(message, innerException)
    {
        ErrorCode = errorCode;
    }
}
...
/// </summary>
public sealed class TenantNotFoundException : AimException
{
...
/// </summary>
public sealed class UnauthorizedTenantAccessException : AimException
{
...
/// </summary>
public sealed class TenantInactiveException : AimException
{
    public Guid TenantId { get; }
...
/// </summary>
public sealed class ResourceNotFoundException : AimException
{
...
/// </summary>
public sealed class IngestionException : AimException
{
    public Guid TenantId { get; }
...
/// </summary>
public sealed class ValidationException : AimException
{
...
/// </summary>
public sealed class CredentialResolutionException : AimException
{
    public Guid TenantId { get; }
