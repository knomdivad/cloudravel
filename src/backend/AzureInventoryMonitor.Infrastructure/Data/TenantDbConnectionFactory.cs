...
public sealed class TenantDbConnectionFactory : ITenantDbConnectionFactory
{
    ...
    {
        _connectionString = configuration.GetConnectionString("AimDatabase")
            ?? configuration["SqlConnectionString"]
            ?? throw new InvalidOperationException("Connection string 'AimDatabase' or 'SqlConnectionString' is required.");
        _logger = logger;
    }
